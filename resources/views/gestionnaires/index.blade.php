        ...
        <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-left">
                            <h2>enregistrer gestionnaires</h2>
                        </div>
                        <div class="pull-right">
                            <a class="btn btn-success" href="{{ route('gestionnaires.create') }}"> Creer un gestionnaire</a>
                        </div>
                    </div>
                </div>
                  ...
                  <tr>
                      ...
                      <td>{{ $gestionnaire->adresse }}</td>
                        ...
                        <td>
                            ...
                            <form action="{{ route('gestionnaires.destroy',$gestionnaire->id) }}" method="POST">
              
                                <a class="btn btn-primary" href="{{ route('gestionnaires.edit',$gestionnaire->id) }}">Edit</a>
                                @csrf
                                @method('DELETE')
