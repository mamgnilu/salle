        ...
        <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-left">
                            <h2>enregistrer moniteurs</h2>
                        </div>
                        <div class="pull-right">
                            <a class="btn btn-success" href="{{ route('moniteurs.create') }}"> Creer un moniteur</a>
                        </div>
                    </div>
                </div>
                  ...
                  <tr>
                      ...
                      <td>{{ $moniteur->adresse }}</td>
                        ...
                        <td>
                            ...
                            <form action="{{ route('moniteurs.destroy',$moniteur->id) }}" method="POST">
              
                                <a class="btn btn-primary" href="{{ route('moniteurs.edit',$moniteur->id) }}">Edit</a>
                                @csrf
                                @method('DELETE')
